...
PGA460_Regs_t s1 = {
    .EEData.UserData = {0}, // 0x00..0x13 all zeros
    .EEData.TVG = {         // 0x14..0x1A
        .TVGAIN0 = 68,
        .TVGAIN1 = 68,
        .TVGAIN2 = 68,
        .TVGAIN3 = 0,
    ...
    .TestMux = { .Val.Value = 0 }, // 0x4B
    .Stat0 = { .Val.Value = 0 }, // 0x4C
    .Stat1 = { .Val.Value = 0 }, // 0x4D
    .THR = { // 0x5F..0x7F
        .P1_THR = {34,0,0,0,0,0,255,255,255,188,224,0,0,0,0,0},
        .P2_THR = {0,0,0,0,0,0,255,255,255,217,199,0,0,0,0,7},
        .THR_CRC = 160
    }
};
PGA460_Regs_t s2 = {
